...
export const s3Storage: S3StoragePlugin =
  ...
  (incomingConfig: Config): Config => {
    ...
    initClientUploads({
      clientHandler: './plugins/s3-storage/S3ClientUploadHandler#S3ClientUploadHandler',
...
function s3StorageInternal(
  ...
  return ({ collection, prefix }): GeneratedAdapter => {
    const collectionStorageConfig = collections[collection.slug as UploadCollectionSlug]
